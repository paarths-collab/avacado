...
export default function MarketplaceCard({ item, onBuy }: MarketplaceCardProps) {
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className="group overflow-hidden border border-foreground/10 bg-card shadow-none hover:border-foreground/20 transition-all duration-300 rounded-leaf relative h-full">
